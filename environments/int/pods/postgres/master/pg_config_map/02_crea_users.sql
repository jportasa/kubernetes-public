...
ALTER ROLE appwtn IN DATABASE wtndbint SET search_path TO wtn4;
ALTER ROLE apptrk IN DATABASE wtndbint SET search_path TO trk;
ALTER ROLE appntf IN DATABASE wtndbint SET search_path TO ntf;
ALTER ROLE appint IN DATABASE wtndbint SET search_path TO "int";
ALTER ROLE appaud IN DATABASE wtndbint SET search_path TO wtn4;
ALTER ROLE appath IN DATABASE wtndbint SET search_path TO wtn4;
ALTER ROLE apppus IN DATABASE wtndbint SET search_path TO wtn4;
ALTER ROLE appsms IN DATABASE wtndbint SET search_path TO wtn4;
ALTER ROLE appgeo IN DATABASE wtndbint SET search_path TO geo;
ALTER ROLE appcredit IN DATABASE wtndbint SET search_path TO credit;
ALTER ROLE appdocdrive IN DATABASE wtndbint SET search_path TO docdrive;
